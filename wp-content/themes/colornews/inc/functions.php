...
function colornews_scripts() {
   ...
   $colornews_user_agent = strtolower($_SERVER['HTTP_USER_AGENT']);
   if(preg_match('/(?i)msie [1-8]/',$colornews_user_agent)) {
      wp_enqueue_script( 'html5', COLORNEWS_JS_URL . '/html5shiv.min.js', true );
   }
...
function colornews_sidebar_select() {
   ...
   $colornews_default_page_layout = get_theme_mod( 'colornews_pages_default_layout', 'right_sidebar' );
   $colornews_default_post_layout = get_theme_mod( 'colornews_single_posts_default_layout', 'right_sidebar' );
